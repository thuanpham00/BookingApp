...
export default function Flight() {
  ...
  const { isAuthenticated, setIsAuthenticated, isProfile, setIsProfile, cartCount } =
      ...
      {loading ? (
        ...
        <Fragment>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="w-full relative min-h-[48vh] md:min-h-[56vh] lg:min-h-[46vh]">
              <img
                src={bg1}
                alt=""
              ...
              <div className="relative z-10 bg-transparent py-3">
                <div className="container">
                  ...
                  <h1
                    className="hidden md:flex justify-center my-4 md:mt-16"
                    aria-label={t("flight.logan")}
                  >
                    <div className="bg-black/40 backdrop-blur-sm px-4 py-2 rounded-md text-center">
                      <span className="block text-white md:text-3xl lg:text-4xl font-semibold tracking-tight drop-shadow-[0_6px_20px_rgba(0,0,0,0.6)]">
                        {t("flight.logan")}
                      </span>
                    </div>
                  </h1>

                  <div className="mt-12 md:mt-8 mx-auto w-full md:w-[90%]">
                    <form
                      autoComplete="off"
                    ...
                    >
                      ...
                      <div className="mt-4 grid grid-cols-4 relative gap-2 flex-wrap">
                        ...
                        <InputSearch
                          ...
                          classNameList={`z-50 absolute left-0 top-20 mb-2 w-full max-h-[300px] ${showListAirport ? "block" : "hidden"} bg-whiteColor overflow-y-auto overflow-x-hidden rounded-sm shadow-sm transition-opacity duration-200 ease-linear`}
                          ref={inputRef}
                          value={searchText}
                        ...
                        <InputSearch
                          ...
                          classNameList={`z-20 absolute top-20 left-0 w-full max-h-[300px] ${showListAirport2 ? "block" : "hidden"} bg-whiteColor overflow-y-auto overflow-x-hidden rounded-sm shadow-sm transition-opacity duration-200 ease-linear`}
                          ref={inputRef2}
                          value={searchText2}
            ...
            <div className="container">
              <div className="mt-8 px-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 items-stretch">
                {[
                  { img: banner3, title: t("flight.title1"), desc: t("flight.desc1") },
                  { img: banner2, title: t("flight.title2"), desc: t("flight.desc2") },
                  { img: banner1, title: t("flight.title3"), desc: t("flight.desc3") }
                ].map((item, idx) => (
                  <article
                    key={idx}
                    className="flex gap-4 p-4 rounded-xl shadow-lg border border-gay-200 bg-gradient-to-br from-white/30 via-white/10 to-white/5 backdrop-blur-sm"
                  >
                    ...
                    <div className="flex flex-col justify-center">
                      <h3 className="text-sm md:text-base lg:text-lg font-semibold text-textColor">
                        {item.title}
                      </h3>
                      <p className="mt-1 text-xs md:text-sm text-sky-500">{item.desc}</p>
                    </div>
                  </article>
                ))}
              </div>

              <section className="mt-10 relative w-full rounded-2xl overflow-hidden min-h-[22vh] md:min-h-[28vh] lg:min-h-[36vh]">
                <div
                  className="absolute inset-0 bg-cover bg-center"
                  style={{
                    backgroundImage: `linear-gradient(180deg, rgba(2,6,23,0.45), rgba(2,6,23,0.25)), url(${bannerFlight})`
                  }}
                  aria-hidden="true"
                />
                <div className="relative z-10 py-8 sm:py-12 lg:py-16">
                  <div className="mx-auto max-w-6xl px-4">
                    <div className="bg-white/6 backdrop-blur-md border border-white/10 rounded-2xl p-4 md:p-6 lg:p-8 shadow-2xl text-center max-w-[900px] mx-auto">
                      <h3 className="text-lg sm:text-2xl font-bold text-white">
                        {t("flight.partner")}
                      </h3>

                      {/* logos: horizontal scroll on mobile, grid on larger */}
                      <div className="mt-4">
                        <div className="flex gap-4 overflow-x-auto py-3 px-2 md:grid md:grid-cols-6 md:gap-6 md:overflow-visible">
                          {bannerAirLineList.map((item, index) => (
                            <div
                              key={index}
                              className="flex-shrink-0 w-28 h-12 md:w-auto md:h-auto md:flex md:items-center md:justify-center"
                            >
                              <div className="p-2 rounded-lg bg-white/10 flex items-center justify-center h-full">
                                <img
                                  src={item}
                                  alt={`airline-${index}`}
              ...
              <section className="mt-8 mb-8 relative w-full rounded-2xl overflow-hidden min-h-[18vh] md:min-h-[24vh] lg:min-h-[28vh] flex items-center justify-center">
                <div
                  className="absolute inset-0 bg-cover bg-center"
                  style={{
                    backgroundImage: `linear-gradient(180deg, rgba(6,30,66,0.35), rgba(2,6,23,0.12)), url(${bannerFlight2})`
                  }}
                  aria-hidden="true"
                />
                <div className="relative z-10 py-8">
                  <div className="mx-auto max-w-4xl px-4">
                    <div className="flex flex-col sm:flex-row items-center gap-4 justify-center sm:justify-between bg-white/6 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-xl">
                      <div className="text-center sm:text-left">
                        <h3 className="text-lg sm:text-2xl font-semibold text-white">
                          {t("flight.payment")}
                        </h3>
                        <p className="mt-2 text-sm text-white/80">
                          Secure payment partners & best rates
                        </p>
                      </div>
                      <div className="w-[120px] sm:w-[160px] flex-shrink-0 bg-white/10 rounded-lg p-3 flex items-center justify-center">

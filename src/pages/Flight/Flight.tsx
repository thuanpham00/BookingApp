...
export default function Flight() {
  ...
  return (
    ...
    <div className="min-h-[1900px] md:min-h-[2120px] lg:min-h-[2100px] bg-[#fff]">
      {loading ? (
                          ...
                          <div className="col-span-4 lg:col-span-2">
                            <div className="flex items-center justify-between flex-wrap md:flex-nowrap gap-2">
                              ...
                              >
                                {/* date ngày đi*/}
                                <div
                                  className={flightType === "roundTrip" ? "w-[50%]" : "w-[100%]"}
                                >
                                  <SelectDate
                                ...
                                <div
                                  className={
                                    flightType === "roundTrip" ? "w-[50%]" : "hidden w-[0%]"
                                  }
                                >
                                  <SelectDate
                                ...
                                <PopoverShadcn>
                                  ...
                                  <PopoverContent>
                                    <div className="p-1 text-textColor text-sm mb-2 bg-[#fedda7]">
                                      <strong className="text-red-500">Lưu ý: </strong>Số lượng vé
                                      em bé sơ sinh không được vượt quá số lượng vé người lớn.
                                    </div>
                                    <div>
                                      <QuantityController
            ...
            <div className="container">
              ...
              <div className="mt-20 md:mt-8 relative w-full h-[200px] md:h-[400px]">
                <img
                  src={bannerFlight}
                  alt="bannerFlight"
                  className="w-0 h-0 md:w-full md:h-full object-cover brightness-50 rounded-3xl shadow-xl"
                />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-2 bg-white p-4 rounded-sm max-w-[400px] w-full rounded-2xl">
              ...
              <div className="mt-20 md:mt-8 relative w-full h-[200px] md:h-[400px]">
                <img
                  ...
                  className="w-0 h-0 md:w-full md:h-full object-cover brightness-50 rounded-3xl shadow-xl"
                />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-2 bg-white p-4 w-[200px] md:w-[400px] rounded-2xl">
